...
const leakMeTimer = new L1Timer();
const wasm_accessLeakMe = leakMeTimer._createwasm(accessLeakMe);
leakMeTimer._setwasm(wasm_accessLeakMe);
for (let i = 0; i < 100000; i++)
accessLeakMe();
leakMeTimer._initialize();
